...
def search_torrent(movie_name : str) -> str:
    ...
    with sync_playwright() as p:
        ...
        try:
            close_popup = page.locator('#Close_fa', timeout=5000)
            close_popup.click()
        except:
            pass
...
def get_torrent_from_link(link : str) -> str:
    ...
    with sync_playwright() as p:
        ...
        try:
            close_popup = page.locator('#Close_fa', timeout10000)
            close_popup.click()
        except:
            pass
...
if __name__ == "__main__":
    ...
    get_torrent_from_link("https://dontorrent.rocks/pelicula/7402/Salvar-al-soldado-Ryan")
